        ...
        <MDBCarouselInner>
          <MDBRow>
            <MDBCarouselItem itemId="1">
              <MDBRow center>
              <MDBCol md="4">
                <MDBCard className="mb-2" style={widthStyle}>
                  ...
                  <MDBCardBody>
                    ...
                    <MDBBtn href="https://www.linkedin.com/in/limjjgabriel/" color="primary">Connect</MDBBtn>
                  </MDBCardBody>
                </MDBCard>
              </MDBCol>
                <MDBCol md="4">
                ...
                <MDBCard className="mb-2" style={widthStyle}>
                  ...
                  <MDBCardBody>
                    ...
                    <MDBBtn href= 'https://www.linkedin.com/in/aditi-saini-3690a9145/' color="primary">Connect</MDBBtn>
                  </MDBCardBody>
                </MDBCard>
              </MDBCol>
              </MDBRow>
              ...
              <MDBRow center>
                ...
                <MDBCard className="mb-2" style={widthStyle}>
                  ...
                  <MDBCardBody>
                    ...
                    <MDBBtn href= 'https://www.linkedin.com/in/mohammed-adnan-azam-2b0a79192/' color="primary">Connect</MDBBtn>
                  </MDBCardBody>
                </MDBCard>
              </MDBCol>
                <MDBCol md="4">
